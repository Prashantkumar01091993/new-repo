...
<h2 class="title"><a href="#">Image Uploads</a></h2>
<form name="f2"  action="ins1.jsp" method="post" onsubmit="return reg()">
...
<table height="120"  >
  ...
  <tr ><td class="s1" align="right">Image Name&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
    ...
    <td class="s1"><input name="behaviour" type="text" ></td></tr>
    ...
    <td class="s1"><input name="category" type="text" ></td></tr>
