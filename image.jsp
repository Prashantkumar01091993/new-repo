...
<form name="f2" action="image1.jsp" method="post" onsubmit="return reg()">
	<%
...
<tr><td><font color="#3333FF"><a href="userfront.jsp">WebSearch</a></font></td><td>&nbsp;&nbsp;&nbsp;Image</td><td>&nbsp;&nbsp;&nbsp;<a href="news.jsp">News</a></td><td>&nbsp;&nbsp;&nbsp;<a href="sports.jsp">Sports</a></td></tr>
